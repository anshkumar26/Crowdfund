        ...
        md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
          <div className="flex flex-col items-center justify-between xl:flex-row">
            <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
              ...
              BlockFundr is a crowdfunding marketplace that connects fundraisers with supporters, 
              providing a platform for secure and transparent funding. 
              It enables anyone to raise and contribute funds seamlessly.
              </p>
              <a
                href="/"
                aria-label=""
              ...
              >
                ...
                <svg
                  ...
                  viewBox="0 0 12 12"
                >
                  <path d="M9.707,5.293l-5-5A1,1,0,0,0,3.293,1.707L7.586,6,3.293,
                  10.293a1,1,0,1,0,1.414,1.414l5-5A1,1,0,0,0,9.707,5.293Z"/>
                </svg>
              </a>
            </div>
              ...
              <div className="bg-white rounded shadow-2xl p-7 sm:p-10">
                ...
                <form>
                  ...
                  <p className="text-xs text-gray-600 sm:text-sm">
                    Create You Campaign for raising funds
                  </p>
                </form>
              </div>
            </div>
